...
- **2. test_idea** — `invention_loop`
  - round_1
    - `chat/prompts/2_test_idea/round_1/1_gen_strat.md` — 4 prompts
    - `2_gen_plan/` — 3 task(s)
    ...
    - `3_gen_art/` — 3 task(s)
      ...
      - `chat/prompts/2_test_idea/round_1/3_gen_art/gen_art_experiment_1.md` — 33 prompts
  ...
  - round_2
    ...
    - `3_gen_art/` — 3 task(s)
      - `chat/prompts/2_test_idea/round_2/3_gen_art/gen_art_evaluation_1.md` — 5 prompts
...
- **3. report_results** — `gen_paper_repo`
  ...
  - `3_gen_full_paper/` — 2 task(s)
    ...
    - `chat/prompts/3_report_results/3_gen_full_paper/gen_paper_site.md` — 4 prompts
